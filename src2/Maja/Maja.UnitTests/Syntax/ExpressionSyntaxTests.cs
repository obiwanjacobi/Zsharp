...
public class ExpressionSyntaxTests
{
    ...
    public void ArithmeticPlusLiterals()
    {
        ...
        expr.Children[0].As<ExpressionLiteralSyntax>().Value.Should().Be("42");
        expr.Children[1].As<ExpressionOperatorSyntax>().Value.Should().Be("+");
        expr.Children[2].As<ExpressionLiteralSyntax>().Value.Should().Be("101");
    }
    ...
    public void ArithmeticMultipleLiterals()
    {
        ...
        expr.Children[4].As<ExpressionLiteralSyntax>().Value.Should().Be("2");
        expr.Children[5].As<ExpressionOperatorSyntax>().Value.Should().Be("+");
        expr.Children[6].As<ExpressionLiteralSyntax>().Value.Should().Be("2112");
    }
    ...
    public void ArithmeticPrecedence()
    {
        ...
        expr.Children[1].As<ExpressionOperatorSyntax>().Value.Should().Be("+");
            ...
            prec.Children[0].As<ExpressionLiteralSyntax>().Value.Should().Be("101");
            prec.Children[1].As<ExpressionOperatorSyntax>().Value.Should().Be("/");
            prec.Children[2].As<ExpressionLiteralSyntax>().Value.Should().Be("2");
        expr.Children[3].As<ExpressionOperatorSyntax>().Value.Should().Be("+");
        expr.Children[4].As<ExpressionLiteralSyntax>().Value.Should().Be("2112");
    }
}
